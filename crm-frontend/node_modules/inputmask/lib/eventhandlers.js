import {
    ...
    seekPrevious,
    translatePosition
} from "inputmask/lib/positioning";
import {keys} from "inputmask/lib/keycode";
import {iphone, mobile} from "inputmask/lib/environment";
import {handleRemove, isComplete, isSelection, isValid} from "inputmask/lib/validation";
import {applyInputValue, checkVal, clearOptionalTail, HandleNativePlaceholder, writeBuffer} from "inputmask/lib/inputHandling";
import {getPlaceholder, getTest} from "inputmask/lib/validation-tests";
